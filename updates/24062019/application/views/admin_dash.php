...
<!-- Mirrored from moltran.coderthemes.com/dark/index.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 14 Jul 2016 12:16:29 GMT -->
    <head>
       ...
       <title>
            <?php 
                echo $this->config->item('company') . ' | ' . $this->lang->line('common_powered_by') . ' IPOS'; 
            ?>
        </title>
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="<?= site_url('home'); ?>" class="logo"><i class="md md-terrain"></i> <span>IPOS</span></a>
                    </div>
                </div>
            ...
            <div class="left side-menu">
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            <li>
                                <a href="<?= site_url('home'); ?>" class="waves-effect waves-light active"><i class="md md-home"></i><span> Dashboard </span></a>
                            </li>																														
                            <li>
                                <a href="<?= site_url(''); ?>" class="waves-effect waves-light">
                            ...
                            <?php foreach($allowed_modules->result() as $module) { ?>
				                <?php if($this->lang->line("module_".$module->module_id)=="Employees"){ ?>
                                    <li>
                                        <a href="<?php echo site_url("$module->module_id");?>" class="waves-effect waves-light">
			                    ...
			                    <?php } elseif ($this->lang->line("module_".$module->module_id)=="Config") { ?>	
						            <li class="has_sub">
                                        ...
                                        <ul class="list-unstyled">
                                            <li>
                                                <a href="<?php echo site_url("$module->module_id");?>">Settings</a>
                                            </li>
                                        </ul>
                                    </li>					
				                <?php }else{ ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-lg-3">
                                <div class="mini-stat clearfix bx-shadow bg-info">
                                    ...
                                    <div class="tiles-progress">
                                        <div class="m-t-20">
                                            <h5 class="text-uppercase text-white m-0">Employees <span class="pull-right">1</span></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 col-lg-3">
                                <div class="mini-stat clearfix bg-purple bx-shadow">
                                    ...
                                    <div class="tiles-progress">
                                        <div class="m-t-20">
                                            <h5 class="text-uppercase text-white m-0">Branches <span class="pull-right">2</span></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-lg-3">
                                <div class="mini-stat clearfix bg-success bx-shadow">
                                    ...
                                    <div class="tiles-progress">
                                        <div class="m-t-20">
                                            <h5 class="text-uppercase text-white m-0">Roles <span class="pull-right">3</span></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-lg-3">
                                <div class="mini-stat clearfix bg-primary bx-shadow">
                                    ...
                                    <div class="tiles-progress">
                                        <div class="m-t-20">
                                            <h5 class="text-uppercase text-white m-0">Last month's Users <span class="pull-right">4</span></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
