                                        ...
                                        <div class="m-t-20">
                                            <h5 class="text-uppercase text-white m-0">
                                                <span class="pull-right">
                                                    <a href="<?php echo site_url("stocks/outofstocks"); ?>" class="btn btn-info btn-sm">view items</a>
                                                </span>
                                            </h5>
                                        </div>
                                    </div>
                                ...
                                <div class="mini-stat clearfix bg-primary bx-shadow">
                                    ...
                                    <div class="tiles-progress">
                                        <div class="m-t-20">
                                            <h5 class="text-uppercase text-white m-0">
                                                <span class="pull-right">
                                                    <a href="<?php echo site_url("stocks/ItemsAtReorderLevel"); ?>" class="btn btn-info btn-sm">view items</a>
                                                </span>
                                            </h5>
                                        </div>
                                    </div>
