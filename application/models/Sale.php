...
class Sale extends CI_Model
{
	...
	*/
	...
	public function lab_accountsave(&$sale_status, &$items, $customer_id, $employee_id, $comment, $invoice_number, $quote_number, $payments, $dinner_table, &$sales_taxes, $invoice_id, $sale_id = FALSE)
	{
		$tax_decimals = $this->config->item('tax_decimals');
