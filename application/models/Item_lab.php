...
class Item extends CI_Model
{
	...
	*/
	...
	public function get_search_suggestions($search, $filters = array('is_deleted' => 0, 'search_custom' => FALSE), $unique = FALSE, $limt = 99999)
	{
		$suggestions = array();
	...
	public function categories_list()
	{
		...
		foreach ($this->db->get()->result() as $row) {
			// $lab_items[] = array('id' => $row->id, 'name' => $row->name, 'type' => $row->type);
