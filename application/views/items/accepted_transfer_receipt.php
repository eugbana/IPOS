			...
			<div id="receipt_general_info">
				<div class="clearfix">
					<div class="pull-right">
						...
						<div id="customer"><?php echo "<b>FROM</b>: " . $from_branch; ?></div>

					</div>

					<div class="pull-left">
						<div id="sale_id"><?php echo "<b>Receiving ID</b>: RECV " . $receivings_id; ?></div>
			...
			<div class="table-responsive">
				<table id="receipt_items" class="table">
					...
					foreach ($items as $line => $item) {
                        ...
                        $total += $item['accepted_quantity'] * $cur_item_info->cost_price;
					?>
						<tr>
							<td><?php echo $sn++; ?></td>
							<td><?php echo $cur_item_info->name; ?></td>
							<td><?php echo $item['item_number']; ?></td>
							<td><?php echo to_quantity_decimals(abs($item['accepted_quantity'])); ?>
							</td>
							<!-- <td><?php //echo to_currency($item['cost_price']); 
										?></td> -->
							<td><?php echo to_currency($cur_item_info->cost_price);
								?></td>

							<td>
								<div class="total-value"><?php echo to_currency($item['accepted_quantity'] * $cur_item_info->cost_price); ?></div>
							</td>
						</tr>
