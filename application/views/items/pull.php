	...
	<div class="content">
		...
		<center>
			...
			<div id="register_wrapper">
				...
				<?php echo form_open($controller_name . "/add_pull", array('id' => 'add_item_form', 'class' => 'form-horizontal panel panel-default')); ?>
				<div class="panel-body form-group">
					<ul>
						...
						<li class="pull-right">
							<div class='btn btn-sm btn-success pull-right' id='pull_button'><?php echo $this->lang->line('common_pull'); ?></div>
						</li>
					</ul>
				</div>
				<?php echo form_close(); ?>
				...
				<table class="sales_table_100" id="register">
					<thead>
						<tr>
							...
							<th style="width: 37%;"><?php echo $this->lang->line('sales_item_name'); ?></th>
							<th style="width: 10%;"><?php echo $this->lang->line('sales_quantity'); ?></th>
							<th style="width: 20%;">From <?php echo $this->lang->line('branch_transfered'); ?></th>
					...
					<tbody id="cart_contents">
						...
						if (count($pull) == 0) {
							...
							<?php
								...
								foreach (array_reverse($pull, TRUE) as $line => $item) {
									?>

								<?php if ($item['reference'] == 0) { ?>
									<?php echo form_open($controller_name . "/edit_item_batch_pull/$line", array('class' => 'form-horizontal', 'id' => 'cart_' . $line)); ?>
									<tr>
										...
										<td><?php
														...
														?><?php echo form_dropdown('location', $locator, $item['location'], array('id' => 'location', 'class' => 'form-control',)); ?></td>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#pull_button").click(function() {
			$('#buttons_form').attr('action', '<?php echo site_url($controller_name . "/global_item_pull_transfer"); ?>');
			$('#buttons_form').submit();
		});
