				...
				<table id="receipt_items" class="table">
					<thead class="thead-light">
						<tr>
                            ...
                            <th style="text-align:right;color: #495057; background-color: #e9ecef;border-color: #dee2e6;">Retail Price</th>
					...
					?>
					<tr>
						<th colspan="7" style='text-align:right;border-top:2px solid #000000;'>Grand Total</th>
