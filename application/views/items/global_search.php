...
<div class="content-page">
    ...
    <div class="print_hide" id="control_buttons" style="text-align:right">
		...
		<div id="required_fields_message"> <b> Global Item Search </b> <br><br> Call up / Search Item to check Price & Quantity</div>
		...
		<fieldset id="item_basic_info">
            ...
            ?>
            <form action="items/global_search" method="get">
                <div class="form-group form-group-sm">
                    <?php echo form_label('Item', 'query', array('class' => 'required control-label col-xs-3')); ?>
                    <div class='col-xs-6'>
                        <div class="input-group">
                            <span class="input-group-addon input-sm"><span class="glyphicon glyphicon-barcode"></span></span>
                            <input type="text" name="query" placeholder="Search for Items" class="form-control input-sm">
                        </div>
                        <br/>
                        
                        <div class="form-group form-group-sm">
                            <div class='col-xs-12'>
                            <input type="submit" value="Search" class="btn btn-primary btn-sm pull-right">
                            </div>
                        </div> 
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <?php foreach($items as $item){ ?>
                                        ...
                                        <tr>
                                            <th scope="row"> <?php echo ucfirst($item['branch_name']) ?> </th>
                                    ...
                                    <?php } ?>
                                    <!-- <tr>
                                        <th scope="row">Capitalhub</th>
                                        <td>VERALINE</td>
                                        <td>VERALINE STERILE NORADRENALINE</td>
                                        <td>6</td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Garki</th>
                                        <td>VERALINE</td>
                                        <td>VERALINE STERILE NORADRENALINE</td>
                                        <td>10</td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Wuse</th>
                                        <td>VERALINE</td>
                                        <td>VERALINE STERILE NORADRENALINE</td>
                                        <td>13</td>
                                    </tr> -->
