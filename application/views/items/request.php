						...
						?>
							...
							?>
								...
								<?php if ($item['reference'] == 0) { ?>
									<?php echo form_open($controller_name . "/edit_item_batch_request/$line", array('class' => 'form-horizontal', 'id' => 'cart_' . $line)); ?>
									<tr>
				...
				?>
					<div class="row " style="background:#BBB;padding-top:5px;padding-bottom:5px;">
						...
						<div class="col-sm-6">
							...
							<?php echo form_dropdown('location', $branches, '', array('id' => 'location', 'style' => 'width:55%;', 'class' => 'form-control',)); ?>
							<?php echo form_close();  ?>
						</div>
						<div class="col-sm-6">
							<li class="pull-right">
							...
							<li class="pull-right">
								<div class='btn btn-sm btn-success pull-right' id='push_button'>Request</div>
							</li>
						</div>
	...
	$(document).ready(function() {
		...
		$("#push_button").click(function() {
			...
			if (location == '') {
				...
				$("#transfer_to_location").val(location);
				$('#buttons_form').attr('action', '<?php echo site_url($controller_name . "/request_items_from_other_branch"); ?>');
				$('#buttons_form').submit();
			}
		});
		...
		$("#cancel_sale_button").click(function() {
			if (confirm('<?php echo $this->lang->line("sales_confirm_cancel_sale"); ?>')) {
				$('#buttons_form').attr('action', '<?php echo site_url($controller_name . "/request_cancel"); ?>');
				$('#buttons_form').submit();
			}
		});
