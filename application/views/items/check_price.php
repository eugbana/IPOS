...
<div class="content-page">
    ...
    <div class="print_hide" id="control_buttons" style="text-align:right">
		...
		<div id="required_fields_message"> Call up / Search Item to check Price & Quantity</div>

		<ul id="error_message_box" class="error_message_box"></ul>

		<?php echo form_open('sales/add_price_check', array('id' => 'iterem_form', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal')); ?>
		<fieldset id="item_basic_info">
			...
			<div class="form-group form-group-sm">
				<?php echo form_label('Item', 'item_number', array('class' => 'required control-label col-xs-3')); ?>
				<div class='col-xs-6'>
                    ...
                    <div class="row">
                            <b><h1 id='price'> <?php echo $name . ' - '. $price; ?> </h1></b>
                    </div>
				</div>
