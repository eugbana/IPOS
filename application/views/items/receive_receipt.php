<?php $this->load->view("partial/header"); ?>
		...
		<div class="print_hide" id="control_buttons" style="text-align:right">
			...
			<?php endif; ?>
			<?php echo anchor("account", '<span class="glyphicon glyphicon-shopping-cart">&nbsp</span>' . $this->lang->line('sales_register'), array('class'=>'btn btn-info btn-sm', 'id'=>'show_sales_button')); ?>
			
		</div>

		<?php $this->load->view("items/" . $this->config->item('receipt_template')); ?>
