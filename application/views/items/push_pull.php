		...
		<!-- Sale Items List -->
			...
			<table class="sales_table_100" id="register">
				<thead>
					<tr>
						<th style="width: 5%;"></th>
						<th style="width: 27%;"><?php echo $this->lang->line('sales_item_name'); ?></th>
						<th style="width: 10%;"><?php echo 'Qty Requested'; ?></th>
						<th style="width: 10%;"><?php echo 'Qty Sent'; ?></th>
						<th style="width: 20%;"><?php echo 'Request '.$this->lang->line('branch_transfered'); ?></th>
				...
				<tbody id="cart_contents">
					...
					{				
						...
						{					
					?>
							<?php echo form_open($controller_name."/edit_item_batch_push_pull/$line", array('class'=>'form-horizontal', 'id'=>'cart_'.$line)); ?>
							...
							<?php if($item['reference']==0){?>
								<tr>
									...
									<td style="align: center;">
										<?php echo to_quantity_decimals($item['requested_quantity']); ?>
									</td>
									...
									<td>
										...
										if($item['is_serialized']==1)
										{
											...
											echo form_hidden('received_quantity', $item['quantity']);
										}
										else
										{								
									...
									<td><?php echo form_input(array('name'=>'batch', 'id'=>'batch', 'class'=>'form-control input-sm', 'size'=>'50', 'tabindex'=>++$tabindex,'placeholder'=>'Add Batch')); ?>
											...
											<?php echo form_hidden('location', $item['location']); ?>
