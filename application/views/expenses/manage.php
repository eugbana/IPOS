				...
				<div class="row" style="margin-left:5px;margin-right:5px;">
					<div id="title_bar" class="btn-toolbar print_hide">
						...
						<button class='btn btn-info btn-sm pull-right modal-dlg' data-btn-submit='<?php echo $this->lang->line('common_submit') ?>' data-href='<?php echo site_url($controller_name . "/view"); ?>' title='<?php echo $this->lang->line($controller_name . '_new'); ?>'>
							<span class="glyphicon glyphicon-tag">&nbsp;</span> New Expense
						</button>

						<a class='btn btn-info btn-sm pull-right'  href='<?php echo site_url('reports/date_input_expenses'); ?>' title='Generate Report'>
							<span class="glyphicon glyphicon-tag">&nbsp;</span> Generate Expense Report
						</a>

						<a class='btn btn-info btn-sm pull-right'  href='<?php echo site_url('expense/categories'); ?>' title='Manage Expense Categories'>
							<span class="glyphicon glyphicon-tag">&nbsp;</span> Manage Expense Categories
						</a>

						<h2 class="mb-3">Expense Account Balance <?php echo $balance; ?></h2> <br/> <br/>
					</div>
				</div>
			<?php } ?>
			<div class="row">
				<div id="toolbar">
					<div class="pull-left form-inline" role="toolbar">
						...
						?>
						<?php 
							echo form_dropdown('type', $types, 'all', array('id' => 'type', 'class' => 'selectpicker show-menu-arrow', 'data-style' => 'btn-default btn-sm', 'data-width' => 'fit'));
						?>
					</div>
				</div>
			</div>
