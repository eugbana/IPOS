                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-lg-3">
                                <div class="mini-stat clearfix bx-shadow" style="background-color: #C0C0C0;">
                                     <a href="<?php echo site_url("account/unprocessed_payment");?>"><span class="mini-stat-icon bg-danger"><i class="ion-share"></i></span></a>
                                    <div class="mini-stat-info text-right">
                                        <span>Unprocess</span>
                                        payments
                                    </div>
                                    <div class="tiles-progress">
                                        <div class="m-t-20">
                                            <h5 class="text-uppercase text-white m-0">Process Payment<span class="pull-right"></span></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-lg-3">
                                <div class="mini-stat clearfix bx-shadow" style="background-color: #C0C0C0;">
                                    <a href="<?php echo site_url("account/processed_payment");?>"><span class="mini-stat-icon bg-danger"><i class="ion-eye"></i></span></a>
                                    <div class="mini-stat-info text-right">
                                        <span>Processed</span>
                                        payments
                                    </div>
                                    <div class="tiles-progress">
                                        <div class="m-t-20">
                                            <h5 class="text-uppercase text-white m-0">View Processed Test <span class="pull-right"></span></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
