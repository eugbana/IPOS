...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        table_support.init({
            ...
            uniqueId: 'stock_intakes.stock_id',
    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div id="title_bar" class="print_hide btn-toolbar">
                ...
                <?php echo anchor("stockintake/new", '<span class="md md-add-shopping-cart">&nbsp</span>Start New Stock Intake', array('class' => 'btn btn-info btn-sm pull-right', 'id' => 'show_receiving_button')); ?>
            </div>
