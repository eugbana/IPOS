							...
							<div class="form-group form-group-sm">
								...
								<table class="sales_table_100" id="payment_details">
									...
									<tr>
										...
										<td><h4><b> <?php echo $title ?></b</h4></td>
									</tr>
									<tr>
										<td><h4><b>Description:  </b</h4></td>
										<td><h4><b> <?php echo $description ?> </b</h4></td>
									</tr>
									<tr>
										<td><h4><b>Total: </b</h4></td>
										<td><h4><b> <?php echo to_currency($total);?></b</h4></td>
									</tr>
								...
								<div class='btn btn-sm btn-success pull-right' id='finish_receiving_button'><span class="glyphicon glyphicon-ok">&nbsp</span> Save </div>
							</div>
							<?php echo form_close(); ?>
						<?php
						}
