                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-lg-3">
                                <div class="mini-stat clearfix bx-shadow" style="background-color: #C0C0C0;">
                                    <a href="<?php echo site_url("laboratory/test_start");?>"><span class="mini-stat-icon bg-danger"><i class="ion-share"></i></span></a>
                                    <div class="mini-stat-info text-right">
                                        <span >New</span>
                                         Test
                                    </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-lg-3">
                                <div class="mini-stat clearfix bx-shadow" style="background-color: #C0C0C0;">
                                    <span class="mini-stat-icon bg-danger" id="search"><i class="ion-eye"></i></span>
                                    <div class="mini-stat-info text-right">
