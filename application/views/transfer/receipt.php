...
<div class="content-page">
	...
	<div class="content">
		...
		<div class="print_hide" id="control_buttons" style="text-align:right">
			...
			<?php echo anchor("lpo/history", '<span class="glyphicon glyphicon-save">&nbsp</span> LPO History', array('class' => 'btn btn-info btn-sm', 'id' => 'show_sales_button')); ?>
		</div>
		...
		<div id="receipt_wrapper">
			...
			<div id="receipt_general_info">
				<div class="clearfix">
					...
					<div class="pull-left">
						<div id="sale_id"><b>LPO ID</b>: <?php echo $lpo_id; ?></div>
					...
					<thead class="thead-light">
						<tr>
							...
							<!-- <th style="width:10%;"><?php //echo $this->lang->line('sales_unit_price'); 
														?></th> -->
							<th style="width:10%;color: #495057; background-color: #e9ecef;border-color: #dee2e6;">Qty Ordered</th>
							<!-- <th style="width:10%;color: #495057; background-color: #e9ecef;border-color: #dee2e6;">Qty Received</th> -->
