...
<div class="content-page">
	...
	<div class="content">
		...
		<div id="register_wrapper">
			...
			<?php echo form_open('', array('id' => 'mode_form', 'class' => 'form-horizontal panel panel-default')); ?>
			<div class="panel-body form-group">
				<ul>
					...
					<li class="pull-left">
						<?php echo anchor("lpo/history", '<span class="md md-history">&nbsp</span>View LPO History ' . $controller_name, array('class' => 'btn btn-info btn-sm pull-right', 'id' => 'show_receiving_history_button')); ?>
					</li>
					...
					?>
						...
						?>
							...
							<tr>
								...
								<td><?php echo form_input(array('name' => 'receiving_quantity', 'class' => 'form-control input-sm', 'value' => $item['receiving_quantity'])); ?></td>
