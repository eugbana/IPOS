...
<fieldset id="receiving_basic_info">
	...
	<div class="form-group form-group-sm">
		...
		<div class='col-xs-8'>
			<?php echo form_input(array('name' => 'date', 'value' => date($this->config->item('dateformat') . ' ' . $this->config->item('timeformat'), strtotime($receiving_info['receiving_time'])), 'id' => 'datetime', 'disabled' => 'disabled', 'class' => 'form-control input-sm', 'readonly' => 'true')); ?>
		</div>
	</div>
	...
	<div class="form-group form-group-sm">
		...
		<div class='col-xs-8'>
			<?php echo form_dropdown('supplier_id', $suppliers, $selected_supplier_id, 'id="supplier_id"  class="form-control"'); ?>
			<?php // echo form_input(array('name' => 'supplier_name', 'value' => $selected_supplier_name, 'id' => 'supplier_name', 'disabled' => 'disabled', 'class' => 'form-control input-sm')); 
			?>
	...
	<div class="form-group form-group-sm">
		...
		<div class='col-xs-8'>
			<?php echo form_dropdown('employee_id', $employees, $receiving_info['employee_id'], 'id="employee_id" disabled class="form-control"'); ?>
		</div>
	</div>
