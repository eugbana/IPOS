...
var url = function () { return `<?php echo site_url('account/get_purchase_day_book_data'); ?>/${type}/${startDate}/${endDate}`};
...
<div class="content-page">
  ...
  <div class="content">
    ...
    <div class="form-group row">
      ...
      <div class="col-xs-3">
        <?php echo form_dropdown('type', ['sales' => 'Purchases',"returns" => 'Returns'], 'small',[
            'id'       => 'type',
      ...
      <div class="col-xs-3">
        <a href="<?php echo site_url('reports/detailed_receivings');?>" class="btn btn-primary" id="viewReport">Generate Report</a>
      </div>
      ...
      <table class="table table-striped table-bordered" id="table">
        <thead>
          <tr>
            ...
            <th width="25%">Particulars (Item/Product)</th>
            <th width="8%">Quantity</th>
            <th width="10%">Purchase Invoice</th>
            <th width="12%">Purchase Amount</th>
            <th width="22%" id="employee_action">Returned by</th>
...
<script>
  ...
  $(document).ready(function() {
    ...
    $('#type').click(function (event) {
      ...
      if(type == "sales") {
        $('#employee_action').html("Purchased By");
      }else {
      ...
      columnDefs: [ 
        {
          ...
          "data": "amount", //this name should exist in your JSON response
          "render": function ( data, type, full, meta ) {
            
            var formated =  new Intl.NumberFormat('ja-JP', { style: 'currency', currency: 'NGN' }).format(data); 

            return (data < 0)? `<span class='text-danger'>${formated}</span>` : formated;
              
          }
        }, 
        {
          "targets": 3,//index of column starting from 0
          "data": "quantity", //this name should exist in your JSON response
          "render": function ( data, type, full, meta ) {
            var formated = data;
            return (data < 0)? `<span class='text-danger'>${formated}</span>` : formated;
