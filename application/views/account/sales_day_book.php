...
var url = function () { return `<?php echo site_url('account/get_cash_day_book_data'); ?>/${type}/${startDate}/${endDate}`};
      ...
      <table class="table table-striped table-bordered" id="table">
        <thead>
          <tr>
            ...
            <th width="10%">Sales Reciept/Invoice Number</th>
            <th width="12%">Sales Amount</th>
            <th width="22%" id="employee_action">Sold by</th>
