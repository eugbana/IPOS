...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="print_hide" id="control_buttons" style="text-align:right">
            ...
            <a class="btn btn-sm btn-info" href="<?php echo site_url('reports/expenses_export/' . $start_date . '/' . $end_date . '/' . $category . '/' . $employee . '/' . $type . '/' . $location_id); ?>">Export Excel</a>
            ...
            <table id="receipt_items" class="table table-hover table-bordered">
                ...
                <tbody>
                    ...
                    foreach ($summary_data as $key => $d) : ?>
                        <tr>
                            <td><?php echo $sn++; ?></td>
                            <td><?php echo ' EXP ' . $d['id']; ?></td>
                            <td><?php echo $d['date']; ?></td>
                            <td><?php echo $d['receipt_no']; ?></td>
                            <td><b><?php echo $d['category']; ?></b></td>
                            <td><?php echo $d['expense_category_type']; ?></td>
                            <td><?php echo $d['details']; ?></td>
                            <td><?php echo $d['employee']; ?></td>
                            <!-- <td><b><?php echo $d['type']; ?></b></td> -->

                            <td><?php echo $d['type'] == 'INFLOW' ? to_currency($d['amount']) : ''; ?></td>
                            <td><?php echo $d['type'] != 'INFLOW' ? to_currency($d['amount']) : ''; ?></td>
