	...
	<div class="content">
		<div class="row">
			...
			<div class="col-md-4">
				<div class="panel panel-primary">
					...
					<div class="list-group">
						...
						?>
						<a class="list-group-item" href="<?php echo site_url('reports/detailed_sales'); ?>">Sales</a>
						<a class="list-group-item" href="<?php echo site_url('reports/detailed_transfers'); ?>">Transfers</a>
					</div>
				</div>
			...
			<div class="col-md-4">
					<div class="panel panel-primary">
						<div class="panel-heading">
							<h3 class="panel-title"><span class="glyphicon glyphicon-list-alt">&nbsp</span>Item Specific Reports</h3>
						</div>
						<div class="list-group">
							<?php
							// $person_id = $this->session->userdata('person_id');
							// show_report_if_allowed('detailed', 'receivings', $person_id);
							?>
							<a class="list-group-item" href="<?php echo site_url('reports/detailed_product_receivings'); ?>">Receivings</a>
							<a class="list-group-item" href="<?php echo site_url('reports/detailed_product_sales'); ?>">Sales</a>
							<!-- <a class="list-group-item" href="<?php echo site_url('reports/detailed_transfers'); ?>">Transfers</a> -->
						</div>
					</div>
			</div>
			...
			<div class="col-md-4">
					<div class="panel panel-primary">
						...
						<div class="list-group">
							<a class="list-group-item" href="<?php echo site_url('reports/expiry_items'); ?>">Item Expiry </a>
						</div>
					</div>
			</div>
