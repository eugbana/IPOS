...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="print_hide" id="control_buttons" style="text-align:right">
            ...
            <a class="btn btn-sm btn-info" href="<?php echo site_url('reports/out_of_stock_export/' . $dept . '/' . $category . '/' . $type . '/' . $vated . '/' . $location_id); ?>">Export Excel</a>
                ...
                <tbody>
                    ...
                    foreach ($summary_data as $key => $d) : ?>
                        <tr>
                            ...
                            <td><?php echo round($d['quantity']); ?></td>
                            <td><?php echo round($d['reorder_level']); ?></td>
                        </tr>
