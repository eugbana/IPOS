...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="print_hide" id="control_buttons" style="text-align:right">
            ...
            <a class="btn btn-sm btn-info" href="<?php echo site_url('reports/vat_tax_export/' . $dept . '/' . $category . '/' . $prescription . '/' . $supplier . '/' . $location_id); ?>">Export Excel</a>
            ...
            <table id="receipt_items" class="table table-hover table-bordered">
                <thead style="background-color: #CCC;color:#FFF;">
                    <tr>
                        ...
                        <th>Quantity</th>
                        <!-- <th>Pack</th> -->
                        <th>VAT Excl. Price</th>
                        <th>VAT Incl. Price</th>
                        <th>Quantity Sold</th>
                        <th>Total VAT</th>
                ...
                <tbody>
                    ...
                    foreach ($summary_data as $key => $d) : ?>
                        <tr>
                            <td><?php echo $sn++; ?></td>
                            <td><?php echo ' ITEM ' . $d['id']; ?></td>
                            <td><?php echo $d['name']; ?></td>
                            <td><?php echo $d['item_number']; ?></td>
                            <td><?php echo $d['category']; ?></td>
                            <td><?php echo to_currency($d['unit_price']); ?></td>
                            <td><?php echo to_currency($d['cost_price']); ?></td>
                            <td><?php echo $d['quantity']; ?></td>
                            <!-- <td><?php echo $d['pack']; ?></td> -->
                            <td><?php echo to_currency($d['vat_excl']); ?></td>
                            <td><?php echo to_currency($d['vat_incl']); ?></td>
                            <td><?php echo $d['quantity_sold']; ?></td>
                            <td><?php echo $d['total_vat']; ?></td>
                            <td><?php echo to_currency($d['total_amount_sold']); ?></td>
                        </tr>
