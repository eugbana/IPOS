...
<div class="content-page">
	...
	<div class="content">
		...
		<div id="page_title"><?php echo 'Out of Stock Report Parameters'; //$this->lang->line('reports_report_input'); 
								?></div>
		...
		<?php echo form_open($controller_name . '/date_input_out_of_stock', array('id' => 'dept_check', 'class' => 'form-horizontal')); ?>
		...
		<!-- <div class="form-group form-group-sm">
			...
			<div class="form-group form-group-sm">
				<?php echo form_label("Report Type", 'reports_type_label', array('class' => ' control-label col-xs-2')); ?>

				<div id='report_sale_vat' class="col-xs-3">
					<?php echo form_dropdown('report_type', $type, 'all', array('id' => 'type', 'class' => ' form-control')); ?>
				</div>
			</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#generate_report").click(function() {
            window.location = ["<?php echo site_url('reports/display_out_of_stock');  ?>", $("#dept").val(), $("#category").val(), $("#type").val(), $("#vat").val(), $("#location_id").val()].join("/");
		});
	});
</script>