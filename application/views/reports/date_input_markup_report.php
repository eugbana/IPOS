...
<div class="content-page">
	...
	<div class="content">
		...
		<div id="page_title"><?php echo 'Markup Report Parameters'; //$this->lang->line('reports_report_input'); 
								?></div>
		...
		<?php echo form_open($controller_name . '/date_input_markup_report', array('id' => 'dept_check', 'class' => 'form-horizontal')); ?>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#generate_report").click(function() {
			window.location = ["<?php echo site_url('reports/display_markup_report');  ?>", $("#start_markup").val(), $("#end_markup").val(), $("#dept").val(), $("#category").val(), $("#vat").val(), $("#suppliers").val(), $("#location_id").val()].join("/");
        });
	});
</script>