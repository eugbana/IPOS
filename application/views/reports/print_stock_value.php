...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="print_hide" id="control_buttons" style="text-align:right">
            ...
            <a class="btn btn-sm btn-info" href="<?php echo site_url('reports/stock_value_export/' . $dept . '/' . $category . '/' . $vated . '/' . $supplier . '/' . $location_id); ?>">Export Excel</a>
                ...
                <tbody>
                    ...
                    foreach ($summary_data as $key => $d) : ?>
                        <tr>
                            ...
                            <td><?php echo to_currency($d['value']); ?></td>
                        </tr>
