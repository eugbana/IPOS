...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="print_hide" id="control_buttons" style="text-align:right">
            ...
            <a class="btn btn-info btn-sm" href="<?php echo site_url('reports/print_filtered_report_items_product_specific_export/' . $start . '/' . $end . '/' . $employee_id . '/' . $location_id . '/' . $sale_type . '/'  . $credit . '/' . $vatable . '/' . $customer_id . '/' . $discount . '/' . $payment_type . '/'. $item_id); ?>">Export Excel</a>
                    ...
                    foreach ($details_data as $key => $dd) : ?>
                        <?php foreach ($dd as $d) : ?>
                            <tr>
                                ...
                                <td><?php echo $sn++; ?></td>
                                <td><a href="sales/receipt/<?php echo $d['id'] ?>">  <?php echo 'POS ' . $d['id']; ?> </a></td>
