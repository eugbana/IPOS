...
<div class="content-page">
	...
	<div class="content">
		...
		<div id="page_title"><?php echo 'Price List Report Parameters'; //$this->lang->line('reports_report_input'); 
								?></div>
		...
		<?php echo form_open($controller_name . '/date_input_price_list', array('id' => 'dept_check', 'class' => 'form-horizontal')); ?>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#generate_report").click(function() {
            window.location = ["<?php echo site_url('reports/display_price_list');  ?>", $("#dept").val(), $("#category").val(), $("#vat").val(), $("#location_id").val()].join("/");
		});
	});
</script>