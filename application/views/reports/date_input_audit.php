...
<div class="content-page">
	...
	<div class="content">
		...
		<div id="page_title"><?php echo 'Audit trail Report Parameters'; //$this->lang->line('reports_report_input'); 
								?></div>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#generate_report").click(function() {
            window.location = ["<?php echo site_url('reports/display_credit');  ?>", start_date, end_date, $("#action_type").val(), $("#employee").val(), $("#location_id").val()].join("/");
        });
	});
</script>