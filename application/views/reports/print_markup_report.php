...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="print_hide" id="control_buttons" style="text-align:right">
            ...
            <a class="btn btn-sm btn-info" href="<?php echo site_url('reports/markup_report_export/' . $start_markup . '/' . $end_markup . '/'  . $dept . '/' . $category . '/' . $vated . '/' . $supplier . '/' . $location_id); ?>">Export Excel</a>
                ...
                <tbody>
                    ...
                    foreach ($summary_data as $key => $d) : ?>
                        <tr>
                            ...
                            <td><?php echo round($d['markup'], 2); ?></td>
                            <td><?php echo $d['markup_percent']; ?>%</td>
                            <td><?php echo to_currency($d['markup_value']); ?></td>
                        </tr>
