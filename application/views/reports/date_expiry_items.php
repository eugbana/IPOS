...
<div class="content-page">
	...
	<div class="content">
		...
		<?php echo form_open($controller_name . '/date_expiry_items', array('id' => 'dept_check', 'class' => 'form-horizontal')); ?>
				...
				<div class="input-group  date datetimepicker3">
					...
					<?php echo form_input(
						array(
							...
							'value' => $unline['time_started'], 'required'=>'required'
						)
					); ?>
				</div>
			</div>
	...
	$(document).ready(function() {
		...
		$("#generate_report").click(function() {
			...
			?>
				...
				window.location = ["<?php echo site_url('reports/expiry_items');  ?>",  "<?php echo date('Y-m-d') ?>", $("#end_date").val().split(" ")[0], $("#dept").val(), $("#category").val(), $("#location_id").val()].join("/");
