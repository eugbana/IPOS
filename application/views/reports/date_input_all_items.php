...
<div class="content-page">
	...
	<div class="content">
		...
		<div id="page_title"><?php echo 'Items Report Parameters'; //$this->lang->line('reports_report_input'); 
								?></div>
		...
		<?php echo form_open($controller_name . '/date_input_all_items', array('id' => 'dept_check', 'class' => 'form-horizontal')); ?>
		...
		<!-- <div class="form-group form-group-sm">
			...
			<div class="form-group form-group-sm">
				<?php echo form_label("Prescription", 'reports_sale_vat_label', array('class' => ' control-label col-xs-2')); ?>

				<div id='report_sale_vat' class="col-xs-3">
					<?php echo form_dropdown('sale_vat', $prescription, 'all', array('id' => 'prescription', 'class' => ' form-control')); ?>
				</div>
			</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#generate_report").click(function() {
            window.location = ["<?php echo site_url('reports/display_all_items');  ?>", $("#dept").val(), $("#category").val(), $("#vat").val(), $("#prescription").val(), $("#suppliers").val(), $("#location_id").val()].join("/");
        });
	});
</script>