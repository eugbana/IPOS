...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        table_support.init({
            resource: '<?php echo site_url($controller_name); ?>' + '/request_history_data',
            headers: <?php echo $table_headers; ?>,
            pageSize: <?php echo $this->config->item('lines_per_page'); ?>,
            uniqueId: 'request.request_id',
    ...
    <div class="content">
        ...
        <div class="row">
            <div id="title_bar" class="print_hide btn-toolbar">
                ...
                <?php echo anchor("items/request_item", '<span class="glyphicon glyphicon-new-window">&nbsp</span>New Request', array('class' => 'btn btn-info btn-sm pull-right', 'id' => 'show_receiving_button')); ?>
            </div>
