	...
	<table id="receipt_items">
		...
		?>
			<tr>
				...
				?>&nbsp;&nbsp;&nbsp;<!-- x -->
				<?php //echo $item['receiving_quantity'] != 0 ? to_quantity_decimals($item['receiving_quantity']) : 1; ?></td>
