    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div id="title_bar" class="print_hide btn-toolbar">
                ...
                <?php echo anchor("receivings", '<span class="md md-add-shopping-cart">&nbsp</span>New Receiving', array('class' => 'btn btn-info btn-sm pull-right', 'id' => 'show_receiving_button')); ?>
            </div>
