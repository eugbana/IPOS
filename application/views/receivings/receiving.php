			...
			<table class="sales_table_100" id="register">
				<thead>
					<tr>
						...
						<!-- <th style="width:10%;"><?php //echo $this->lang->line('receivings_cost_retail'); ?></th> -->
					...
					?>
							<?php echo form_open($controller_name."/edit_item/$line", array('class'=>'form-horizontal', 'id'=>'cart_'.$line)); ?>
								<tr>
									...
									<td><div class="input-group  date datetimepicker1" id="datetimepicker1">
									...
									<!-- <td><?php //echo form_input(array('name'=>'unit_price', 'class'=>'form-control input-sm', 'value'=>to_quantity_decimals($item['unit_price']))); ?></td> -->
