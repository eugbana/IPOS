...
<head>
	...
	<?php if ($this->input->cookie('debug') == 'true' || $this->input->get('debug') == 'true') : ?>
		...
		<link rel="stylesheet" type="text/css" media="all" href="css/receipt.css" />
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$('.blockUI').remove();
			if (window.location.href.endsWith('sales/complete_receipt') || window.location.href.endsWith('sales/add_payment')) {
				window.print();
			}
		});
	</script>
