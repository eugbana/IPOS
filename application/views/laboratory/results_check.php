...
<script>
	$(document).ready(function() {
		...
		$(document).on('click', '.update', function() {
			...
			$('#userModal').modal('show'); //was commented
			$('#sale_id').val(user_id);
			$('.modal-title').text("Process");
			$('#action').val("Print");
			//$('#action').submit();//was not commented before
			//$('#item_form').submit();//was not commentted before
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					Select Tests to Print. Select nothing to print all.
				</div>
				<?php
				...
				foreach ($tests as $row) {
					echo '
						...
						<input class="form-check-input" name="tests[]" type="checkbox" id="' . $row['test_name'] . '" value="' . $row['item_id'] . '" >
						<label class="form-check-label" for="' . $row['test_name'] . '">
						  ' . $row['test_name'] . '
						</label>
					  		</div>
						';
