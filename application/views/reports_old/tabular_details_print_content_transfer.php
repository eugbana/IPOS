...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="print_hide" id="control_buttons" style="text-align:right">
            ...
            <a class="btn btn-sm btn-info" href="<?php echo site_url('reports/print_filtered_report_items_transfers_export/' . $start_date . '/' . $end_date . '/' . $employee_id . '/' . $from_branch . '/' . $to_branch); ?>">Export Excel</a>
                ...
                <tbody>
                    ...
                    foreach ($summary_data as $key => $d) : ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo to_currency($d['item_cost_price']); ?></td>
                            <td><?php echo to_currency($d['item_unit_price']); ?></td>
                            <td><?php echo to_currency($d['transfer_price']); ?></td>
                            <td><?php echo round($d['quantity'], 0); ?></td>
                            <td><?php echo to_currency($d['total']); ?></td>
                            <td><?php echo ucfirst($d['employee_name']);; ?></td>
