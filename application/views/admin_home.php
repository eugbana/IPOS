    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-lg-3">
                                <div class="mini-stat clearfix bx-shadow" style="background-color: #C0C0C0;">
                                    <span class="mini-stat-icon bg-danger"><i class="ion-share"></i></span>
                                    <div class="mini-stat-info text-right">
                                        <span >Click</span>
                                        New Test
                                    </div>
                                    <div class="tiles-progress">
                                        <div class="m-t-20">
                                            <h5 class="text-uppercase text-white m-0">Begins a Test Request <span class="pull-right"></span></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-lg-3">
                                <div class="mini-stat clearfix bx-shadow" style="background-color: #C0C0C0;">
                                    <span class="mini-stat-icon bg-danger"><i class="ion-eye"></i></span>
                                    <div class="mini-stat-info text-right">
                                    ...
                                    <div class="tiles-progress">
                                        <div class="m-t-20">
                                            <h5 class="text-uppercase text-white m-0">Check Test Result Status <span class="pull-right"></span></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <footer class="footer text-center">© 2018 - <?php echo date("Y") ?>   <a href="www.istrategytech.com">Powered By Infostrategy.</a><?php echo date('Y')?> © Infostrategy.
                </footer>
