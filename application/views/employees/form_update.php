			...
			<div class="tab-pane" id="employee_permission_info">
				<fieldset>
					...
					<div class="form-group form-group-sm" style="margin-top:10px">
						<?php echo form_label('', 'role_permission', array('class' => 'control-label col-xs-3')); ?>
						<div class='col-xs-4'>
							<?php echo form_dropdown('role_permission', $roles, $selected_role, array('id' => 'role_permission', 'class' => 'form-control')); ?>
						</div>
					</div>

					<input type="hidden" name="receiving_quantity" id="receiving_quantity">
					<ul id="permission_list" style="display:none" class="check_default">
			...
			submitHandler: function(form) {
				$(form).ajaxSubmit({
					success: function(response) {
						...
						table_support.refresh(); //newly added.not important
					},
					dataType: 'json'
				});
			},
