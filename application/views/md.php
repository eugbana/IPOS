...
<head>
    ...
    <link href="dist/assets/css/stylet.css" rel="stylesheet" type="text/css">
            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="row bg-white">
                        ...
                        <?php $i = 1; ?>
                        <?php foreach ($newSales as $row => $value) { ?>

                            <div class="col-md-2 col-sm-4">
                                <div class="stats-overview stat-block">
                                    <div class="display stat good huge">
                                        <span>
                                            <img src="images/icon-statistic.png" height="30px" />
                                        </span>
                                        <div class="percent">
                                    ...
                                    <div class="details">
                                        <div class="title">
                                            <b> <?php echo $value['location_name']; ?></b>
                                        </div>
                                        <div>Stock:<?php echo ' ' . $value['stock_quan']; ?></div>
                                        <div>Expire:<?php echo ($value['expiry_quan'] == '') ? 0 : $value['expiry_quan']; ?></div>
                                        <div>Out Stock:<?php echo ($value['stock_out'] == '') ? 0 : ' ' . $value['stock_out']; ?></div>
                                        <div class="numbers">
                                            NGN <?php print(number_format($value['sales_amount'])); ?>
                                        </div>
                                    </div>
                                    <div class="progress">
                                        <span style="width: 80%;" class="progress-bar progress-bar-success" aria-valuenow="66" aria-valuemin="0" aria-valuemax="100">
                                            <span class="sr-only">
                                            </span>
                                        </span>
                                    </div>
